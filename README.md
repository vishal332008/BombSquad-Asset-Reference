...
### 🎨 Texture Reference
- Browse all 431 in-game textures across 22 categories (characters, bombs, powerups, UI, achievements, medals, fonts, and more)
- Live search/filter by name
- Click any texture name to instantly copy it to your clipboard
- Hover preview shows the actual image before you commit to using it

### 🧊 Mesh Viewer
- Full 3D preview of any `.obj` mesh, rendered with Three.js
...
- Toggleable display modes:
  ...
  - Real-time shadows
  - Reference grid
- Reset view button to snap back to the default camera angle

### 🖌️ Texture Preview on Mesh (New)
- Apply any of the 431 reference textures directly onto a loaded mesh to see how it wraps using the mesh's real UV data — no artificial tiling or distortion
- Searchable picker makes finding the right texture fast
...
## Tech Stack
- Vanilla HTML/CSS/JS
- [Three.js](https://threejs.org/) (r158) for 3D rendering, loaded via ESM
...
- **Textures page:** From the homepage, head to the Textures section to search or browse by category. Click any texture name to copy it to your clipboard, and hover over it to preview the actual image.
